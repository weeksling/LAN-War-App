...
class DownloadStaffData(val inStream:InputStream, val cloudDate :String, val staffPageRef:StorageReference, val staffDAO: StaffDAO, val imageFilePath:String) :Runnable{
    ...
    override fun run() {
            ...
            for (i in 0 until sponsorList.length) {
                ...
                if (node.nodeType == Node.ELEMENT_NODE) {
                    ...
                    val imageFolder = staffPageRef.child("sponsor_logos")
